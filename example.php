...
<!--        <pigeon-chart query="SELECT school, gender, COUNT(gender) AS Total FROM student GROUP BY gender" title="Students from Swinburne, UCTS and Sunway Group By Gender" subtitle="BICT and CS Students" type="column" axisy-title="Count" axisx-title="Gender" data-data-label="true">Placeholder for generic chart</pigeon-chart>
