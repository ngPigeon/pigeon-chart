...
<body>
    ...
    <div>
        ...
        <pigeon-chart query="SELECT relyear, min(runtime), avg(runtime), max(runtime) FROM movie GROUP BY relyear" title="Stock Quotes For DiGi" subtitle="Comparison between open, high, low and close price" type="line" axisy-title="Stock Quotes" axisx-title="Date" data-data-label="false" show-legend="true">Placeholder for generic chart</pigeon-chart>
